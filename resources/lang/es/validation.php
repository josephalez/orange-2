...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'address'                => 'dirección',
        'birthday'               => 'cumpleaños',
        'carnet_expiration'      => 'expiración carnet',
        'type'                   => 'tipo',
        'comuna'                 => 'comuna',
        'class'                  => 'clase',
        ...
        'delivery_region'        => 'región de entrega',
        'delivery_commune'       => 'comuna de entrega',
        'delivery_phone'         => 'teléfono de entrega',
        'delivery_date'          => 'fecha de entrega',
        'delivery_initial_time'  => 'hora inicial de entrega',
        'delivery_final_time'    => 'hora final de entrega',
        'description'            => 'descripcion',
        'mark'                   => 'marca',
        'image'                  => 'imagen', 
        'price'                  => 'precio',
        'activation_price'       => 'precio de activacion',
        'points'                 => 'puntos',
        'prepaid_price'          => 'precio prepago',
